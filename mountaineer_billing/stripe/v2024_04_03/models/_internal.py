...
class AccountAnnualRevenue(BaseModel):
    amount: Annotated[
        int | None,
        Field(
            description='A non-negative integer representing the amount in the [smallest currency unit](https://stripe.com/docs/currencies#zero-decimal).'
        ),
    ] = None
    currency: Annotated[
        str | None,
...
MountaineerBillingApiVersion = Literal["2024-04-03"]
