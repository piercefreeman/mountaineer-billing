...
MountaineerBillingApiVersion = Literal["2023-10-16"]
...
class IssuingNetworkTokenDevice(BaseModel):
    ...
    type: Annotated[
        Type14 | None, Field(description='The type of device used for tokenization.')
    ] = None
...
class PaymentLinksResourceCustomFieldsLabel(BaseModel):
    ...
    type: Annotated[Type22, Field(description='The type of the label.')]
...
class PaymentMethodDetailsCardInstallmentsPlan(BaseModel):
    ...
    type: Annotated[
        Type25, Field(description='Type of installment plan, one of `fixed_count`.')
    ]
...
class DisputePaymentMethodDetails(BaseModel):
    ...
    type: Annotated[Type9, Field(description='Payment method type.')]
...
class FundingInstructionsBankTransferFinancialAddress(BaseModel):
    ...
    type: Annotated[Type10, Field(description='The type of financial address')]
...
class IssuingCardShipping(BaseModel):
    ...
    type: Annotated[Type13, Field(description='Packaging options.')]
...
class PaymentIntentNextActionDisplayBankTransferInstructions(BaseModel):
    ...
    type: Annotated[Type18, Field(description='Type of bank transfer')]
...
class PaymentLinksResourceCustomFields(BaseModel):
    ...
    type: Annotated[Type21, Field(description='The type of the field.')]
...
class ConnectAccountReference(BaseModel):
    ...
    type: Annotated[Type5, Field(description='Type of the account referenced.')]
...
class Mandate(BaseModel):
    ...
    type: Annotated[Type17, Field(description='The type of the mandate.')]
...
class Payout(BaseModel):
    ...
    type: Annotated[Type31, Field(description='Can be `bank_account` or `card`.')]
...
class TaxIDsOwner(BaseModel):
    ...
    type: Annotated[Type37, Field(description='Type of owner referenced.')]
...
class PhysicalBundleModel(BaseModel):
    features: IssuingPhysicalBundleFeatures | None = None
    id: Annotated[
        str, Field(description='Unique identifier for the object.', max_length=5000)
    ]
    livemode: Annotated[
...
class TransactionModel(BaseModel):
    ...
    type: Annotated[Type12Model2, Field(description='The nature of the transaction.')]
    wallet: Annotated[
        Wallet | None,
        Field(
