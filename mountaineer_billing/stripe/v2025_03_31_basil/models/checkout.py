...
class Session(BaseModel):
    ...
    client_secret: Annotated[
        str | None,
        Field(
            description='The client secret of your Checkout Session. Applies to Checkout Sessions with `ui_mode: embedded`. Client secret to be used when initializing Stripe.js embedded checkout.',
            max_length=5000,
        ),
    ] = None
...
class Session(_MountaineerBillingOriginalSession):
    mountaineer_billing_api_version: Literal['2025-03-31.basil'] = '2025-03-31.basil'
