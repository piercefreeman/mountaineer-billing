...
class ExcludedPaymentMethodType(RootModel[str]):
...
class Session(BaseModel):
    ...
    branding_settings: PaymentPagesCheckoutSessionBrandingSettings | None = None
    ...
    customer_account: Annotated[
        str | None,
        Field(description='The ID of the account for this Session.', max_length=5000),
    ] = None
    ...
    excluded_payment_method_types: Annotated[
        list[ExcludedPaymentMethodType] | None,
        Field(
    ...
    name_collection: PaymentPagesCheckoutSessionNameCollection | None = None
    object: Annotated[
        Object11Model,
        Field(
    ...
    ui_mode: Annotated[
        UiMode | None,
        Field(description='The UI mode of the Session. Defaults to `hosted_page`.'),
    ] = None
    url: Annotated[
        str | None,
        Field(
...
class Session(_MountaineerBillingOriginalSession):
    mountaineer_billing_api_version: Literal['2026-03-25.dahlia'] = '2026-03-25.dahlia'
