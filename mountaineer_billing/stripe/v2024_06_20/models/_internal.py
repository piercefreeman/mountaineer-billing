...
MountaineerBillingApiVersion = Literal["2024-06-20"]
...
class IssuingAuthorizationFuelData(BaseModel):
    ...
    type: Annotated[
        Type14 | None, Field(description='The type of fuel that was purchased.')
    ] = None
    unit: Annotated[
...
class IssuingNetworkTokenDevice(BaseModel):
    ...
    type: Annotated[
        Type16 | None, Field(description='The type of device used for tokenization.')
    ] = None
...
class PaymentLinksResourceCustomFieldsLabel(BaseModel):
    ...
    type: Annotated[Type25, Field(description='The type of the label.')]
...
class SetupFutureUsage43(StrEnum):
    off_session = 'off_session'
    on_session = 'on_session'
...
class PaymentMethodDetailsCardInstallmentsPlan(BaseModel):
    ...
    type: Annotated[
        Type28, Field(description='Type of installment plan, one of `fixed_count`.')
    ]
...
class SetupFutureUsage49(StrEnum):
    none = 'none'
    off_session = 'off_session'
    on_session = 'on_session'
...
class SetupFutureUsage51(StrEnum):
    none = 'none'
...
class SetupFutureUsage62(StrEnum):
    none = 'none'
    off_session = 'off_session'
...
class SetupFutureUsage63(StrEnum):
    none = 'none'
...
class PaymentPagesCheckoutSessionCustomFieldsLabel(BaseModel):
    ...
    type: Annotated[Type33, Field(description='The type of the label.')]
...
class DisputePaymentMethodDetails(BaseModel):
    ...
    type: Annotated[Type10, Field(description='Payment method type.')]
...
class FundingInstructionsBankTransferFinancialAddress(BaseModel):
    ...
    type: Annotated[Type11, Field(description='The type of financial address')]
...
class IssuingCardShipping(BaseModel):
    ...
    type: Annotated[Type15, Field(description='Packaging options.')]
...
class PaymentIntentNextActionDisplayBankTransferInstructions(BaseModel):
    ...
    type: Annotated[Type21, Field(description='Type of bank transfer')]
...
class PaymentLinksResourceCustomFields(BaseModel):
    ...
    type: Annotated[Type24, Field(description='The type of the field.')]
...
class PaymentPagesCheckoutSessionCustomFields(BaseModel):
    ...
    type: Annotated[Type32, Field(description='The type of the field.')]
...
class ConnectAccountReference(BaseModel):
    ...
    type: Annotated[Type6, Field(description='Type of the account referenced.')]
...
class Mandate(BaseModel):
    ...
    type: Annotated[Type19, Field(description='The type of the mandate.')]
...
class Payout(BaseModel):
    ...
    type: Annotated[Type35, Field(description='Can be `bank_account` or `card`.')]
...
class TaxIDsOwner(BaseModel):
    ...
    type: Annotated[Type42, Field(description='Type of owner referenced.')]
...
class TransactionModel(BaseModel):
    ...
    type: Annotated[Type13Model2, Field(description='The nature of the transaction.')]
    wallet: Annotated[
        Wallet | None,
        Field(
